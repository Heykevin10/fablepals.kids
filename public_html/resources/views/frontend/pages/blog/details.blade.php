                                        ...
                                        <div class="col-md-5">
                                            <div class="post-share">
                                                ...
                                                <div class="social-btn style3 justify-content-md-end">
                                                    <a class="share-social" href="{{ route('single.blog', $blog?->slug) }}" data-platform="facebook">
                                                        <span class="link-effect">
                                                            <span class="effect-1"><i class="fab fa-facebook"></i></span>
                                                            <span class="effect-1"><i class="fab fa-facebook"></i></span>
                                                        </span>
                                                    </a>
													<a class="share-social" href="javascript:void(0)" data-platform="facebook" onclick="whatsApp()">
                                                        <span class="link-effect">
                                                    ...
                                                    <!--<a  class="share-social" href="{{ route('single.blog', $blog?->slug) }}" data-platform="linkedin">
                                                        <span class="link-effect">
                                                            <span class="effect-1"><i class="fab fa-linkedin"></i></span>
                                                            <span class="effect-1"><i class="fab fa-linkedin"></i></span>
                                                        </span>
                                                    </a>
                                                    <a  class="share-social" href="{{ route('single.blog', $blog?->slug) }}" data-platform="twitter">
                                                        <span class="link-effect">
                            ...
                            @auth('web')
                                <div class="comment-respond">
                                    ...
                                    <form action="{{ route('blog.comment.store', $blog->slug) }}" method="post"
                                        class="comment-form">
                                        <p class="comment-notes">{{__('Share your thoughts on this post! Your insights and feedback are welcome.')}}</p>
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-12">
                                    ...
                                    @foreach ($popular_blogs as $blog)
                                        <div class="sidebar__post-item">
                                            <div class="sidebar__post-thumb">
                                                <a href="{{ route('blogs', $blog?->slug) }}"><img
                                                        src="{{ asset($blog?->image) }}" alt="{{ $blog?->title }}"></a>
                                            </div>
                                            <div class="sidebar__post-content">
                                                <h5 class="title"><a
                                                        href="{{ route('blogs', $blog?->slug) }}">{{ Str::limit($blog?->title, 30, '...') }}</a>
                                                </h5>
                                                <span class="date"><i
                                                        class="flaticon-time"></i>{{ formattedDate($blog?->created_at) }}</span>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
...
<script>
	function whatsApp() {
		var text = "{{ $blog_title }} - {{ route('single.blog', $blog_slug) }}";
