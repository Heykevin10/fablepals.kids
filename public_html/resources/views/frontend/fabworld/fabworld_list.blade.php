...
<section class="bg-dark text-white py-5 storyline arsenal-section">
    <div class="container">
	<h2 class="text-uppercase text-center mb-4 storyline_title section-title">{{$category->name}}</h2>
					...
					<div class="col-md-4 p-4">
						<div class="feature-card"
							...
							<div class="feature-card-icon">
								<a href="{{ route('fabworld.profile', $service?->slug) }}"><img src="{{ asset($service?->banner) }}" alt="{{ $service?->banner_heading }}"></a>
							</div>
							<h4 class="feature-card-title">
								<a href="{{ route('fabworld.profile', $service?->slug) }}">{{ $service?->banner_heading }}</a>
							</h4>
							<p class="feature-card-text"></p>
							<a href="{{ route('fabworld.profile', $service?->slug) }}" class="link-btn">
