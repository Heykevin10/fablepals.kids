    ...
    <div class="mobile-menu-area">
        ...
        <div class="mobile-menu">
            <ul>
                ...
                @endforeach
{{-- =========================
   Auth Links (Side Drawer)
========================= --}}
@auth('web')
    <li class="mobile-only-auth {{ request()->routeIs('dashboard') ? 'active' : '' }}">
        <a href="{{ route('dashboard') }}" class="text-uppercase drawer-auth-link">
            Dashboard
        </a>
    </li>
    ...
    <li class="mobile-only-auth">
        <a href="javascript:;"
           class="text-uppercase drawer-auth-link"
           onclick="event.preventDefault(); document.getElementById('drawer-logout-form').submit();">
            Logout
        </a>

        <form id="drawer-logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
            @csrf
        </form>
    </li>
@else
    <li class="mobile-only-auth {{ request()->routeIs('login') ? 'active' : '' }}">
        <a href="{{ route('login') }}" class="text-uppercase drawer-auth-link">
            Sign In
        </a>
    </li>
@endauth
