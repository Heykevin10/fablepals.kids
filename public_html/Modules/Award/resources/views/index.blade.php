...
@section('title')
    <title>{{ __('Award Section') }}</title>
@endsection
@section('admin-content')
    <div class="main-content">
        <section class="section">
            <x-admin.breadcrumb title="{{ __('Award Section') }}" :list="[
                            ...
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    @if (checkAdminHasPermission('award.management'))
                                        <div>
                                            <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#itemColorModal"
                                                class="btn btn-primary"><i class="fa fa-plus"></i>{{ __('Add Color') }}</a>
                                        </div>
    ...
    @if (checkAdminHasPermission('award.management'))
        <div tabindex="-1" role="dialog" id="itemColorModal" class="modal fade">
            <div class="modal-dialog" role="document">
                <form class="modal-content" action="{{ route('award.color') }}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">{{ __('Add/Update Color') }}</h5>
                        <button type="button" class="btn-close itemColorModalClose"></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group col-12">
                            <input type="text" name="color" value="{{!empty($border_color)?$border_color:''}}" class="form-control" required>
                        </div>

                    </div>
                    <div class="modal-footer bg-whitesmoke br">
                        <button type="button" class="btn btn-danger itemColorModalClose">{{ __('Close') }}</button>
