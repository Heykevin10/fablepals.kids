...
Route::post('/admin/product/delete-file', [ProductController::class, 'deleteFile'])->name('admin.product.deleteFile');
Route::post('/admin/product/delete-zip', [ProductController::class, 'deleteZipFile'])->name('admin.product.deleteZip');
