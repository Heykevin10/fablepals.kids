                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body">
										...
										<div class="form-group">
                                            <label>{{ __('Multiple Files') }}</label>
                                            <input type="file" class="form-control" name="product_files[]" accept="image/*,.pdf" multiple >
                                            @error('product_files')
                                                <span class="text-danger error-message">{{ $message }}</span>
                                            @enderror
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <select name="fabworld_id" class="form-control select2"
                                                ...
                                                @foreach ($fabworlds as $fabworld)
                                                    <option
                                                        {{ $fabworld->id == old('fabworld_id') ? 'selected' : '' }}
                                                        value="{{ $fabworld->id }}">{{ $fabworld->banner_heading }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('fabworld_id')
										...
										<div class="form-group">
                                            ...
                                            <select name="character_id" class="form-control select2"
                                                ...
                                                @foreach ($characters as $character)
                                                    <option
                                                        {{ $character->id == old('character_id') ? 'selected' : '' }}
                                                        value="{{ $character->id }}">{{ $character->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('character_id')
