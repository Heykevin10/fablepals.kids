                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div>
                                    <x-admin.add-button :href="route('admin.character.create')" />
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            @forelse ($projects as $project)
                                                <tr>
                                                    ...
                                                    @adminCan('project.management')
                                                        <td>
                                                            <input class="change-status" data-href="{{route('admin.character.status-update',$project->id)}}"
                                                        ...
                                                        <td>
														<a href="{{ route('character.profile', $project->slug) }}" class="btn btn-info btn-sm" target="_blank">
															<i class="fa fa-eye" aria-hidden="true"></i>
														</a>
                                                            <x-admin.edit-button :href="route('admin.character.edit', [
                                                                'project' => $project->id,
                                                                'code' => getSessionLanguage(),
                                                            ])" />
                                                                <a href="{{ route('admin.character.destroy', $project->id) }}"
                                            ...
                                            @empty
                                                <x-empty-table :name="__('Project')" route="admin.character.create" create="yes"
